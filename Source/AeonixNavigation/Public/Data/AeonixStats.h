...
DECLARE_CYCLE_STAT(TEXT("Dynamic Region Sync"), STAT_AeonixDynamicSync, STATGROUP_Aeonix);

// Async Dynamic Region Stats (3 levels of granularity)
DECLARE_CYCLE_STAT(TEXT("Dynamic Region Async"), STAT_AeonixDynamicAsync, STATGROUP_Aeonix);
